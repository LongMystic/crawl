...
def main():
    ...
    while True:
        ...
        for product in driver.find_elements(By.XPATH, "//div[@class='row slider-items mb-3 product_tab']/div"):
            product_image = product.find_element(By.XPATH, "./div[1]/a").get_attribute("href")
            product_url = product.find_element(By.XPATH, "./div[1]/a//img").get_attribute("src")
